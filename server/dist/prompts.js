...
exports.backupPrompt = exports.counselorPrompt = exports.SUGGESTION_BUCKETS = void 0;
const zod_1 = require("zod");
// Zod schema for response validation
const ResponseSchema = zod_1.z.object({
    message: zod_1.z.string(),
    follow_up_question: zod_1.z.string(),
...
const counselorPrompt = ({ journal, mood, tags = [], recent = [], profile, lastAssistantOpeners = [], lastAssistantQuestions = [], lastSuggestionBucket }) => {
...
exports.counselorPrompt = counselorPrompt;
function buildContextNote(recent, profile) {
...
const backupPrompt = ({ journal, mood, tags = [], recent = [], profile, lastAssistantOpeners = [], lastAssistantQuestions = [] }) => {
...
exports.backupPrompt = backupPrompt;
